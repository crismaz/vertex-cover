...
class BipartiteGraph {
    ...
    bool findAugmentingPathFrom(int, std::vector<int>&, std::vector<bool>&) const;
    bool findAugmentingPaths(std::vector<int>& mate) const;
...
public:
    ...
    bool isMatchingOptimal(std::vector<int> mate) const;
    ...
    std::vector<int> findMatching() const;
    ...
    std::vector<bool> findVertexCoverFromMatching(const std::vector<int>& mate) const;
};
